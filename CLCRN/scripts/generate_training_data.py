...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--attri_names", type=list, default=['temp', 'hum','pres','rain', 'ws'], help="data name."
    )
    parser.add_argument(
        "--output_dirs", type=list, default=['data/temperature','data/humidity', 'data/pressure', 'data/rainfall','data/wind_speed'], help="Output directory."
    )
    parser.add_argument(
        "--step_size", type=int, default=24
    )
    parser.add_argument(
        "--input_seq_len", type=int, default=24
    )
    parser.add_argument(
        "--output_horizon_len", type=int, default=48
    )
    parser.add_argument(
        '--start_date', type=str, default='2016-01-01'
    )
    parser.add_argument(
        '--end_date', type=str, default='2025-12-31'
    )
    parser.add_argument(
